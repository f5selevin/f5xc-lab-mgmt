...
class Xcaisecurity extends Course {
    ...
    async newStudent({ email, namespace: requestedNamespace, deploymentId, ollama, hostArcadia, ceArcadia, udfHost, ip, region, awsAccountId, awsApiKey, awsApiSecret, awsRegion, awsAz, vpcId, subnetId, log }) {
